...
| :--- | :--- | :--- | :--- |
| **Windows** | `Packinbag-offline-win-portable_1.0.6.zip` | [**다운로드 (Windows .zip)**](https://github.com/appfle-io/packinbag-app/releases/download/v1.0.6-offline-portable/Packinbag-offline-win-portable_1.0.6.zip) | ~245 MB |
| **macOS** | `Packinbag-offline-mac-portable_1.0.6.zip` | [**다운로드 (macOS .zip)**](https://github.com/appfle-io/packinbag-app/releases/download/v1.0.6-offline-portable/Packinbag-offline-mac-portable_1.0.6.zip) | ~232 MB |
