...
| :--- | :--- | :--- | :--- |
| **Windows** | `Packinbag-offline-win-portable_1.0.2.zip` | [**다운로드 (Windows .zip)**](https://github.com/appfle-io/packinbag-app/releases/download/v1.0.2-offline-portable/Packinbag-offline-win-portable_1.0.2.zip) | ~245 MB |
| **macOS** | `Packinbag-offline-mac-portable_1.0.2.zip` | [**다운로드 (macOS .zip)**](https://github.com/appfle-io/packinbag-app/releases/download/v1.0.2-offline-portable/Packinbag-offline-mac-portable_1.0.2.zip) | ~232 MB |
...
* **원본 메모가 엉망이 되는 문제**: "이번 외출에만 잠깐 필요한 짐"을 메모에 덧붙여 적었다가, 다음번에 쌀 때는 필요 없어서 지우다 보면 결국 원래 써둔 기본 템플릿 메모까지 엉망이 되곤 했습니다.
...
* **노션(Notion)**: 짐 한 번 싸자고 켜기엔 너무 무겁고 복잡하며, 밖에서 빠르게 확인하기엔 로딩이 답답합니다.
...
* **팩 (Pack)**: 가방 안에 쏙 들어가는 **카테고리 묶음(모듈)**입니다.
  ...
  * **메모 에디터 팩**: 짐 목록 외에 챙겨야 할 주의사항, 장소 링크, 메모, 사진 등을 자유롭게 적어둡니다.
  * **폴더 정리**: 팩이 많아지면 보관함에서 폴더를 만들어 깔끔하게 분류할 수 있습니다.
* **짐 (Item)**: 팩 안의 **개별 준비물 항목**입니다. 누가 챙길지 담당자를 정하거나 마감일을 둘 수 있고, 댓글이나 이모지 리액션도 남길 수 있습니다.
...
* **실시간 함께 체크하기 & 공유**:
  ...
  * **읽기 전용 웹 링크 제공**: 앱이 없거나 로그인하지 않은 상대방에게도 링크 하나로 현재 짐 챙김 현황을 깔끔한 웹 화면으로 실시간 공유할 수 있습니다.
* **Gemini AI 스마트 정리**:
  * **AI 가방 점검**: 여행지나 일정에 맞춰 빠뜨린 필수 짐이나 주의사항을 추천해 줍니다.
