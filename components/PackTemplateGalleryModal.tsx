...
export default function PackTemplateGalleryModal({
  ...
  return (
    <Portal>
      <div
        className="fixed inset-0 z-[120] flex items-center justify-center p-3 md:p-4"
      ...
      {isInspecting && (
        <div
          className="fixed inset-0 z-[150] flex flex-col items-center justify-center gap-3 p-4"
