...
import GuideHeroMotion from "./GuideHeroMotion";
...
export type CategoryFilter = "all" | "ai" | "basics" | "memo" | "share";
...
export default function GuideContent({
  ...
  return (
    <div className={`flex-1 flex flex-col min-h-0 overflow-hidden ${className}`}>
      ...
      {/* 본문 스크롤 영역 */}
      <div className="flex-1 overflow-y-auto px-4 py-5 max-w-2xl mx-auto w-full flex flex-col gap-6 scrollbar-thin">
        {/* 상단 히어로 모션 */}
